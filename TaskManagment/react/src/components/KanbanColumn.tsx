...
const KanbanColumn: React.FC<KanbanColumnProps> = ({ title, index, id, tasks, setTasks }) => {
  ...
  return (
    <div className='kanban__column'>
      ...
      <button className='add-task' onClick={handleClick}>Add new task <img src={Plus}/></button>
    </div>
  );
};
