...
export default function Menu() {
  ...
  return (
    <ul className="menu">
      <li
        className={`menu__element menu__element--arrow ${isProjectsSubMenuOpen ? "menu__element--open" : ""}`}
      ...
      <li
        className={`menu__element menu__element--arrow  ${isMyTasksSubMenuOpen ? "menu__element--open" : ""}`}
        onClick={toggleMyTasksSubMenu}
      >
        <img src={Tasks} /> My tasks
      </li>
